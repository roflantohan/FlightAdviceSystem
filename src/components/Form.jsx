...
const Form = () => {
  ...
  return (
    <div className="ml-2 border rounded bg-slate-200">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex float-right m-2 mr-3">
          <button
            className="w-9 border border-gray-300 rounded p-1 mr-2"
            type="submit"
          >
            Add
          </button>
          <button className="border border-gray-300 rounded p-1" type="submit">
            Check
          </button>
        </div>
